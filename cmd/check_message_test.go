...
func TestCheckMessage(t *testing.T) {
	...
	go func() {
		...
		os.Args = []string{"", "--config", path + "/../features/.githelpy.toml", "check", "message", "feat(cmd) : everything is fine\n"}
...
func TestCheckMessageWithBadMessage(t *testing.T) {
	...
	go func() {
		...
		os.Args = []string{"", "--config", path + "/../features/.githelpy.toml", "check", "message", "everything is fine\n"}
